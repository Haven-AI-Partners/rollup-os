-- Insert translator prompt version 1
...
Translate all pages provided.',
  true,
  'v1: Added explicit format preservation rules — tables must keep exact structure, headings/lists/paragraphs preserved 1:1.'
);
