...
import { DealChatLazy } from "@/components/deals/deal-chat-lazy";
...
export default async function DealDetailLayout({
  ...
  return (
    <div>
      {/* Sticky header + tabs */}
      <div className="sticky top-0 z-10 bg-background -mx-3 px-3 sm:-mx-6 sm:px-6 pb-0 pt-0 border-b">
        <div className="flex items-start gap-4 pb-3">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-3 flex-wrap">
              <h1 className="text-xl sm:text-2xl font-bold">{deal.companyName}</h1>
              <Badge
            ...
            {deal.description && (
              <p className="mt-1 text-sm text-muted-foreground line-clamp-2 sm:line-clamp-none">{deal.description}</p>
            )}
